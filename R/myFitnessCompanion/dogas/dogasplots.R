...
dir.create(file.path( paste(imagesdir, "/myFitnessCompanion/user/", username, sep="") ), showWarnings = FALSE)
filenamebp = paste(imagesdir, "/myFitnessCompanion/user/", username, "/", obsname, "bp.png", sep = "")
filenamexy = paste(imagesdir, "/myFitnessCompanion/user/", username, "/", obsname, "xy.png", sep = "")
