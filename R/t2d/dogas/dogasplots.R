...
if (length(x) > 0) {
  ...
  dir.create(file.path( paste(imagesdir, "/t2d/user/", username, sep="") ), showWarnings = FALSE)
  filenamebp = paste(imagesdir, "/t2d/user/", username, "/", obsname, "bp.png", sep = "")
  filenamexy = paste(imagesdir, "/t2d/user/", username, "/", obsname, "xy.png", sep = "")
